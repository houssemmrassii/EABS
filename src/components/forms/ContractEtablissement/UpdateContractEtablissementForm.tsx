...
import { updateContractEtablissement } from "@/services/ContractEtablissement";

type Props = {
  recordData: ContractEtablissementDataType;
  setEditing: React.Dispatch<
    React.SetStateAction<ContractEtablissementDataType | null>
  >;
  refrech: boolean;
...
const UpdateContractEtablissementForm = (props: Props) => {
  ...
  const onFinish = async (values: any) => {
    try {
      ...
      await updateContractEtablissement(recordData?.id, payload);
...
export default UpdateContractEtablissementForm;
